    ...
    <div className='flex min-h-screen bg-gray-50'>
      ...
      <div className='flex-1 p-6'>
        <EmployeeHeader
          ...
          subtitle='Manage your leave requests and track your quota'
        />
            ...
            <CardContent>
              ...
              <div className='w-full bg-gray-200 rounded-full h-2'>
                <div
                  ...
                  style={{
                    width: `${
                      (leaveQuota.annual.used / leaveQuota.annual.total) * 100
                    }%`,
                  }}
                ></div>
              </div>
            ...
            <CardContent>
              ...
              <div className='w-full bg-gray-200 rounded-full h-2'>
                <div
                  ...
                  style={{
                    width: `${
                      (leaveQuota.sick.used / leaveQuota.sick.total) * 100
                    }%`,
                  }}
                ></div>
              </div>
            ...
            <CardContent>
              <div className='flex justify-between items-center mb-2'>
                <span className='text-2xl font-bold text-orange-600'>
                  {leaveQuota.emergency.remaining}
                </span>
                <span className='text-sm text-gray-600'>days left</span>
              </div>
              <div className='w-full bg-gray-200 rounded-full h-2'>
                <div
                  ...
                  style={{
                    width: `${
                      (leaveQuota.emergency.used / leaveQuota.emergency.total) *
                      100
                    }%`,
                  }}
                ></div>
