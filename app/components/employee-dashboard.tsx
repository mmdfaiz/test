...
import { useDocuments } from '../../hooks/use-supabase-data';
...
export function EmployeeDashboard() {
  ...
  //       description: `Welcome to work! Checked in at ${new Date(
  //         result.check_in
  //       ).toLocaleTimeString()}`,
  //     });
  //   }
  ...
  //       description: `Have a great day! Worked for ${
  //         result.hours_worked || 0
  //       } hours.`,
  //     });
  //   }
  // };
      ...
      <div className='grid grid-cols-1'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest documents shared by the company
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* <div className="space-y-3">
